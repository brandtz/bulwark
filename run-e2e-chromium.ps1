...
# W5-1 / EH-R: bypass the login rate-limiter during e2e — the suite
# authenticates as ~12 personas back-to-back which trips the 5/min limit.
$env:BULWARK_RATE_LIMIT_DISABLED = '1'
